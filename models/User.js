...
const departmentRoles = {
  engineering: ["Mechanic", "Executive"],
  production: ["Team Leader", "Group Leader", "Value stream executive", "Value stream manager"],
  technical: ["Staff member", "Executive"],
  quality: ["Staff member", "Executive"],
  cutting: ["Staff member", "Executive"],
  industrialeng: ["Staff member", "Executive"],
...
const userSchema = new mongoose.Schema({
  ...
  // 🔧 store user's assigned place explicitly
  section: {
    type: String,
    required: function () {
      return (
        (this.department === "engineering" && this.role === "Mechanic") ||
        (this.department === "production" && this.role === "Team Leader")
      );
    },
  },
  line: {
  ...
  // keep your production structure if you still need it for production users
  production: {
    type: { sections: [sectionSchema] },
    required: function () {
      return this.department === "production";
    },
  },
